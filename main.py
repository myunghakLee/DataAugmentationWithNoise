...
parser.add_argument('--train', type=str, default = 'vanilla', choices =['vanilla','mixup', 'mixup_hidden',
                                                                        'cutout', 'vanilla_cutout', 'vanilla_cutout_consistency_reg', 
...
parser.add_argument('--adv_unpre', action='store_true', default=True,
...
def validate_FGSM_4(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=4 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm4** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_1(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=1 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm1** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_8(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=8 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm8** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_16(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=16 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm16** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_32(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=32 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm32** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_64(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=64 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm64** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)

    return top1.avg, losses.avg


def validate_FGSM_128(val_loader, model, log):
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # get adv images
        # pgd_attack = torchattacks.PGD(model, eps=4 / 255, alpha=8 / 255)
        pgd_attack = torchattacks.FGSM(model, eps=128 / 255)
        adversarial_images = pgd_attack(input_var, target_var)
    ...
    print_log(
        '  **Test_fgsm128** Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} Error@1 {error1:.3f} Loss: {losses.avg:.3f} '.format(
            top1=top1, top5=top5, error1=100 - top1.avg, losses=losses), log)
